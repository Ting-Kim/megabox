...
<body>
	...
	<section id="layer_login_select" class="modal-layer"
		...
		<a href="" class="focus">레이어로 포커스 이동 됨</a> <a href="#" class="focus"
			title="레이어로 포커스 이동 됨">레이어로 포커스 이동 됨</a>
								...
								<div class="col left">
									<div class="login-input-area">
										<input autocomplete="off" id="ibxLoginId" maxlength="20"
											...
											class="input-text strTrim"> <input autocomplete="off"
											id="ibxLoginPwd" maxlength="20" type="password"
											placeholder="비밀번호" title="비밀번호를 입력하세요"
										...
										<button id="btnLogin" type="button"
											class="button purple large btn-login" disabled="disabled">로그인</button>

										<div class="link">
											<a href="<%=path%>/user-find" title="ID/PW 찾기 선택">ID/PW 찾기<!--ID/PW 찾기--></a>
											<a href="<%=path%>/join" title="회원가입 선택">회원가입<!--회원가입--></a> <a
												href="<%=path%>/on/oh/ohg/MbLogin/viewNonMbLogin.rest"
												title="비회원 예매확인 선택">비회원 예매확인<!--비회원 예매확인--></a>
										</div>

										<div class="sns-login">
											<a href="javaScript:void(0)" lnkgty="FACEBOOK"
												title="페이스북으로 로그인 선택"><img src="" alt="페이스북">
												페이스북으로 로그인</a> <a href="javaScript:void(0)" lnkgty="NAVER"
												title="네이버로 로그인 선택"><img src="" alt="네이버"> 네이버로
												로그인</a> <a href="javaScript:void(0)" lnkgty="KAKAO"
												title="카카오톡으로 로그인 선택"><img src="" alt="카카오톡">
												카카오톡으로 로그인</a> <a href="javaScript:void(0)" lnkgty="PAYCO"
												title="페이코로 로그인 선택"><img src="" alt="페이코"> 페이코로
												로그인</a>
										</div>
									</div>
								</div>
								...
								<div class="col left">
									...
									<div class="no-member-login-table">
										<table
											...
											<caption>이름, 생년월일, 휴대폰번호, 인증번호, 비밀번호, 비밀번호 확인 항목을
												가진 비회원 로그인 입력 표</caption>
											<colgroup>
											...
											<tbody>
													...
													<td>
														<div class="hp-input">
															...
															<button id="nonMbCertNoSend" type="button"
																class="button gray" disabled="disabled">인증요청</button>
														</div>
												...
												<tr>
													<th scope="row"><label for="ibxNonMbPwdConfirm">비밀번호확인</label>
													</th>
		...
		<div class="util-area">
			<div class="left-link">
				<a href="#" title="VIP LOUNGE">VIP LOUNGE</a> <a href="#"
					title="멤버십">멤버십</a> <a href="#" title="고객센터">고객센터</a>
			</div>
	...
	<script>
	   $('.gnb-depth1').find('a').on("hover", function() {
	                      
	                           $('.gnb-depth1').find('li').removeClass();
			...
			<nav id="gnb" class="">
				<ul class="gnb-depth1">
					...
					<li class=""><a href="<%=path %>/theater/list.do" class="gnb-txt-theater"
						title="극장">극장</a>
						<div class="gnb-depth2">
							<ul>
		...
		<div id="contents">
			<div class="main-page">
				<div class="main-notice-layer" style="display: none;">
					<div class="img">
						<a title="<메가7포인트 위크> 포인트로 최대 77% OFF!"
							href="https://megabox.co.kr/event/detail?eventNo=8485"><img
							src="https://img.megabox.co.kr/SharedImg/frontBanner/2020/07/01/wTDhcssdkkFuRJdrhbnNrbpanpSecvav.jpg"
							alt="<메가7포인트 위크> 포인트로 최대 77% OFF!" onerror="noImg(this, 'main');"></a>
					</div>
					<div class="util">
						<input type="checkbox" id="no_see"> <label for="no_see"
							id="label_no_see">다시 보지 않기</label>
						<button type="button" class="btn-close-main-notice">메인 공지
							닫기</button>
					</div>
				</div>
				<div id="main_section01" class="section main-movie on">
					<div class="bg">
						...
						<img
							src="https://img.megabox.co.kr/SharedImg/2020/06/26/Iqs6FGbxVHJoFt0yIkWs16RsfjnyWIEu_380.jpg"
							alt="반도_2차포스터_01.jpg" onerror="noImg(this, 'main');">
					</div>
					...
					<div class="cont-area">
						...
						<a href="#" class="more-movie" title="더 많은 영화보기"> 더 많은 영화보기 <i
							...
							<ol class="list">
								<li name="li_accmAdncList" style="display: none;" class="first">
									<a href="#" class="movie-list-info" title="영화상세 보기">
										...
										alt="#살아있다" class="poster" onerror="noImg(this, 'main');">
										<div class="wrap">
								...
								<li name="li_boxoRankList" class="first"><a href="#"
									class="movie-list-info" title="영화상세 보기">
										<p class="rank">
											1<span class="ir">위</span>
										</p> <!-- to 개발 : alt 값에 영화 제목 출력 --> <img
										src="https://img.megabox.co.kr/SharedImg/2020/06/26/IMRLp64rBXADlKOBW8GecnH6f4ggmFcG_420.jpg"
										alt="반도" class="poster" onerror="noImg(this, 'main');">
								...
								<!-- 각 map 별 첫번째 li 에 first클래스 추가 -->
								<li name="li_boxoRankList" class=""><a href="#"
									class="movie-list-info" title="영화상세 보기">
										<p class="rank">
											2<span class="ir">위</span>
										</p> <img
										src="https://img.megabox.co.kr/SharedImg/2020/06/25/3gb42ssCByzttkbWdwXtePY3L4DIQjTW_420.jpg"
										alt="밤쉘: 세상을 바꾼 폭탄선언" class="poster"
								...
								<li name="li_boxoRankList" class=""><a href="#"
									class="movie-list-info" title="영화상세 보기">
										...
										src="https://img.megabox.co.kr/SharedImg/2020/06/23/4jr7i0mDwxOpILVarLlS05gmjZt8GiPp_420.jpg"
										alt="[시네도슨트] 빈센트 반 고흐 미술관&amp;크롤러 뮐러 미술관" class="poster"
										onerror="noImg(this, 'main');">
										<div class="wrap" style="display: none; opacity: 1;">
											<div class="summary">내용</div>
											<div class="score">
								...
								<li name="li_megaScoreList" style="display: none;" class="first">
									<a href="#" class="movie-list-info" title="영화상세 보기">
										...
										src="https://img.megabox.co.kr/SharedImg/asis/system/mop/poster/2019/02/2B617F-FEDB-4722-B3D2-C8238C1339D0.large.jpg"
										alt="보희와 녹양" class="poster" onerror="noImg(this, 'main');">
										<div class="wrap">
											<div class="summary">내용</div>
											<div class="score">
												<div class="preview">
								...
								<li name="li_megaScoreList" style="display: none;" class="">
									<a href="#" class="movie-list-info" title="영화상세 보기">
										...
										src="https://img.megabox.co.kr/SharedImg/asis/system/mop/poster/2019/E1/3AEA44-BAD3-4D2E-BB68-8490F6523BA7.large.jpg"
										alt="가버나움" class="poster" onerror="noImg(this, 'main');">
										<div class="wrap">
											<div class="summary">내용</div>
											<div class="score">
												<div class="preview">
								...
								<li name="li_megaScoreList" style="display: none;" class="">
									<a href="#" class="movie-list-info" title="영화상세 보기">
										...
										src="https://img.megabox.co.kr/SharedImg/asis/system/mop/poster/2016/BB/613A6D-2389-4946-BD85-29155BDEE2FF.large.jpg"
										alt="다가오는 것들" class="poster" onerror="noImg(this, 'main');">
										<div class="wrap">
											<div class="summary">내용</div>
											<div class="score">
												<div class="preview">
								...
								<li name="li_megaScoreList" style="display: none;" class="">
									<a href="#" class="movie-list-info" title="영화상세 보기">
										...
										src="https://img.megabox.co.kr/SharedImg/2020/06/15/mkuTBD77ntyhS0FQUuZcYX03Fh3Cur6K_420.jpg"
										alt="[오페라] 아크나텐 @The Met" class="poster"
										onerror="noImg(this, 'main');">
										<div class="wrap">
											<div class="summary">내용</div>
											<div class="score">
					...
					<div class="wrap">
						...
						<div class="slider main-condition">
									...
									<div class="position">
										<div class="txt" style="top: 0px; opacity: 1;">
											<a href="#" target="_self" title=""><img
												src="https://img.megabox.co.kr/SharedImg/BnftMng/2020/06/30/oH2Uzq7dWWj6sv3WyUleFH8qS8xbb9dZ.jpg"
												alt="" onerror="noImg(this, 'main');"></a>
										</div>
										<div class="bg" style="left: 300px; opacity: 1;">
											<a href="#" target="_self" title=""><img
												src="https://img.megabox.co.kr/SharedImg/BnftMng/2020/06/30/VZXUprYvo8Qx3fUCa6Kzb1tlBxmYGowz.jpg"
												alt="" onerror="noImg(this, 'main');"></a>
										</div>
									</div>
								</div>
								<div class="cell"
									...
									<div class="position">
										<div class="txt" style="top: 100px; opacity: 0;">
											<a href="#" target="_self" title="메가박스 오리지널 티켓북 출시"><img
							...
							<div class="slider-control">
								...
								<div class="page">
									<span class="on" style="width: 50%"></span><span class=""
										style="width: 50%"></span>
								</div>

								<div class="util">
									<button type="button" class="btn-prev" disabled="true"
										style="opacity: 0.5;">이전 이벤트 보기</button>
						...
						<div class="brn-ad">
							<div class="banner">
								...
								<div class="size small">
									<a href="#" data-no="8117" data-netfunnel="N" class="eventBtn"
										title=""> <img
										src="https://img.megabox.co.kr/SharedImg/event/2020/02/11/ZDfCOz9hSvsotF2pjEuSdC8Lsl6R9jzH.jpg"
										alt="[코엑스] 더 부티크 프라이빗" onerror="noImg(this, 'main');">
									</a>
								</div>
							</div>
						</div>
								...
								<div
									...
									<div class="swiper-wrapper"
										...
										<div class="cell swiper-slide swiper-slide-active"
											...
											<a href="#" data-no="8448" data-netfunnel=""
												class="eventBtn new"
												title="힐링 프리미엄 극장, 창원내서 6월 24일(수) OPEN! 페이지로 이동"> <span
												...
												<p class="date">20.06.24</p> <img
												src="/static/pc/images/common/bg/bg-noimage-main.png"
												alt="힐링 프리미엄 극장, 창원내서 6월 24일(수) OPEN!"
												onerror="noImg(this, 'main');"> <!-- 이벤트 이미지 적용하지 않고 기본이미지 사용 2019.08.29 -->
											</a>
										</div>
										<div class="cell swiper-slide swiper-slide-next"
											style="width: 242.333px;">
											<a href="#" data-no="8447" data-netfunnel=""
												class="eventBtn new"
												title="세종에서 제일 편안한 극장, 세종청사 6월 24일(수) OPEN! 페이지로 이동"> <span
												class="label"> <em>신규오픈</em>
											</span>
												<p class="area">
												...
												<p class="date">20.06.24</p> <img
												src="/static/pc/images/common/bg/bg-noimage-main.png"
												alt="세종에서 제일 편안한 극장, 세종청사 6월 24일(수) OPEN!"
												onerror="noImg(this, 'main');"> <!-- 이벤트 이미지 적용하지 않고 기본이미지 사용 2019.08.29 -->
											</a>
										</div>
										<div class="cell swiper-slide" style="width: 242.333px;">
											<a href="#" data-no="8446" data-netfunnel=""
												class="eventBtn new"
												title="품격있는 당신을 위한 명품극장, 대전현대아울렛 6월 24일(수) OPEN! 페이지로 이동">
												<span class="label"> <em>신규오픈</em>
											</span>
				...
				<div id="main_section03" class="section main-curation">
					<div class="wrap">
						<div class="tit-util">
							...
							<div class="right">
								<a href="#" title="큐레이션 더보기">큐레이션 더보기 <i
									class="iconset ico-more-corss gray"></i></a>
							</div>
						</div>
						...
						<div class="curation-area">
							<div class="curr-img">
								...
								<div class="img">
									<a href="#" title="영화상세 보기"> <img
										src="https://img.megabox.co.kr/SharedImg/2020/06/23/lepsjCKRQ84828xXV8miut1CmdnNG1X4_420.jpg"
										alt="[특별 상영] 베토벤 프로젝트" onerror="noImg(this, 'main');">
									</a>
								</div>
								...
								<div class="info classic">
									...
									<p class="summary">
										[상영 정보]<br>- 상영 지점 : 코엑스, 센트럴, 목동, 킨텍스, 분당, 성수, 마산 (4주
										상영)<br>- 추가 상영 지점 : 강남, 송도, 영통, 부산대, 대전현대아울렛, 세종청사 (2주
										상영)<br>- 러닝 타임 : 140분 * 인터미션 없음<br>- 상영 일정 : 2020년
										7월 12일 ~ 8월 5일 / 수, 일 (1회씩) 상영<br>- 배급사 사정에 따라 상영 일정 및 지점
										등이 변경될 수 있습니다.<br>
										<br>제작 및 출연<br>작곡: 루트비히 판 베토벤 Ludwig van Beethoven<br>안무:
										존 노이마이어 John Neumeier<br>지휘: 시몬 휴잇 Simon Hewett<br>연주:
										미할 비아르크 (피아노), 도이치 방송 오케스트라 Michal Bialk (Piano), Deutsche
										Radio Philharmonie<br>무용: 함부르크 발레단 Hamburg Ballett<br>공연
										장소: 바덴-바덴 축제극장 Festspielhaus Baden-Baden<br>
										<br>루트비히 판 베토벤: 알레시 마르티네즈 Aleix Martinez<br>베토벤의
										‘이루어지지 않은 사랑’: 안나 로더 Anna Laudere<br>베토벤의 ‘이상향’: 드윈 레바초프
										Edvin Revazov<br>베토벤의 어머니: 패트리샤 프리차 Patricia Friza<br>베토벤의
										조카: 보르하 베르무데즈 Borja Bermudez<br>크리스토퍼 에반스 Christopher
										Evans<br>마크 후베테 Marc Jubete<br>에밀 마종 Emilie Mazon<br>박윤수
										Yun-Su Park<br>
										<br>작품 소개<br>독일 바덴-바덴 축제극장에서 베토벤 탄생 250주년을 기념해 공연된
										기념비적인 발레 실황이다. 함부르크 발레단의 총감독이자 세계적으로 유명한 천재 안무가, 존 노이마이어가 창작한
										작품으로, 고난도 발레 테크닉으로 가득 찬 표현주의 발레를 선보인다. 인간 베토벤의 삶에서 영감 받은 1부는
										베토벤의 자전적인 이야기를 통해 개인적인 고뇌와 좌절을 그리고 있으며, 자유로운 극작법을 따르는 2부는
										현대무용과 정통발레 사이를 오가며 희망을 노래한다.<br>‘에로이카 변주곡’, 교향곡 3번 ‘영웅’과
										더불어 쉽게 접하기 힘든 베토벤 작곡의 발레곡을 중심으로 구성되는 공연은 독일 정상급 교향악단의 연주로
										진행된다. 특히 피아니스트 미할 비아르크가 무대 위 그랜드 피아노를 연주하며 피아노 음색을 무용 속에 완전히
										녹여내는 장면은 인상적이다. 악성 베토벤이 남긴 위대한 걸작과 경이로운 선율에 맞춰 움직이는 세계적인 발레단의
										몸짓은 베토벤의 삶과 음악을 짙은 예술성으로 엮어낸다.<br>
										<br>주요 음악<br>- 변주곡과 푸가 Eb 장조, Op. 35 ‘에로이카 변주곡’<br>-
										피아노 3중주 D 장조, Op. 70, No. 1 ‘유령’<br>- 피아노 소나타 D 장조, Op.
										10, No. 3<br>- 프로메테우스의 창조물, Op. 43<br>- 교향곡 제3번, Eb
										장조, Op. 55 ‘영웅’<br>
										<br>수입/배급 케빈앤컴퍼니<br>
									</p>
								</div>
							...
							<div class="list">
								<ul>
									...
									<li><a href="javascript:gfn_moveDetail('20022500');"
										title="영화상세 보기">
											<p class="bage film">필름소사이어티</p>
											<div class="img">
												<img
													src="https://img.megabox.co.kr/SharedImg/2020/06/23/UXvGh8i7KuMOZzLntFo88hmdcF7vPDvt_230.jpg"
													alt="트랜짓" onerror="noImg(this, 'main');">
											</div>
									...
									<li><a href="javascript:gfn_moveDetail('20027700');"
										title="영화상세 보기">
											<p class="bage classic">클래식소사이어티</p>
											<div class="img">
												<img
													src="https://img.megabox.co.kr/SharedImg/2020/06/23/KUSs4KyOVlKT7SGGH9y6xLV6XvCjXuPR_230.jpg"
													alt="[팝콘클래식] 베토벤과 나폴레옹의 악연" onerror="noImg(this, 'main');">
											</div>
				...
				<div id="main_section04" class="section main-info">
					...
					<div class="info-special">
						<a href="#" title="부티크 페이지로 이동" class="bg-boutique">부티크</a> <a
							href="#" title="MX 페이지로 이동" class="bg-mx">MX</a> <a href="#"
							title="COMFORT 페이지로 이동" class="bg-comfort">COMFORT</a> <a
							href="#" title="MEGA KIDS BOX 페이지로 이동" class="bg-kids">MEGA
							KIDS BOX</a> <a href="#" title="THE FIRST CLUB 페이지로 이동"
					...
					<div class="info-notice">
						<div class="wrap">
							<p class="tit">지점</p>
							<p class="link">
								<a href="#" title="공지사항 상세보기"> <strong> [문경] </strong> [문경]
									7월휴관일 안내
								</a>
							</p>
