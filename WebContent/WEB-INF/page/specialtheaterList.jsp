...
<head>
	...
	<link rel="shortcut icon" href="<%=path%>/static/pc/images/favicon.ico" />
		...
		<meta property="og:url" 		id="fbUrl"		content="https://www.megabox.co.kr/specialtheater/list" />
		<meta property="og:title" 		id="fbTitle"	content="메가박스 특별관" />
		<meta property="og:description"	id="fbDtls"		content="영화의 감동을 더 해줄 메가박스만의 특별관을 만나보세요."/>
