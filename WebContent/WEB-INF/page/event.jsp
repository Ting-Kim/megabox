...
<!-- 화면ID  M-ME-LO-01 -->
<!-- 화면ID  M-ME-CC-01 -->
<div style="display:none;"><a id="loginPupupATag" href="#" class="button active btn-modal-open" w-data="850" h-data="484"></a></div>
...
<div class="container">
	...
	<div class="page-util">
		<div class="inner-wrap">
			<div class="location">
				<span>Home</span>
				<a href="#" onclick="NetfunnelChk.aTag('EVENT_LIST','/event');return false;" title="이벤트 메인 페이지로 이동">이벤트</a>

				
					<a href="#" onclick="NetfunnelChk.aTag('EVENT_LIST','/event');return false;" title="진행중 이벤트 페이지로 이동">진행중 이벤트</a>
				...
				<div class="tab-list fixed">
					<ul>
						<li class="on" id="eventTab_"><a href="#" title="전체">전체</a></li>
							<li id="eventTab_CED03"><a href="event/megaPick.do" title="메가Pick 탭으로 이동">메가Pick</a></li>
							<li id="eventTab_CED01"><a href="#" title="영화 탭으로 이동">영화</a></li>
							<li id="eventTab_CED02"><a href="#" title="극장 탭으로 이동">극장</a></li>
							<li id="eventTab_CED05"><a href="#" title="제휴/할인 탭으로 이동">제휴/할인</a></li>
							<li id="eventTab_CED04"><a href="#" title="시사회/무대인사 탭으로 이동">시사회/무대인사</a></li>
