...
<!-- Mirrored from www.megabox.co.kr/theater?brchNo=1372 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jul 2020 06:35:51 GMT -->
...
<head>
	...
	<link rel="shortcut icon" href="<%=path %>static/pc/images/favicon.ico" />
		...
		<meta property="og:url" 		id="fbUrl"		content="theateredf1.html?brchNo=1372" />
	...
	<!-- by태호, script src 경로 수정 및 js 코딩 주석 처리 (2020.07.13) -->
	...
	<div id="layer_sitemap" class="header-layer layer-sitemap">
        ...
        <div class="wrap">
            ...
            <div class="list position-4">
                ...
                <ul class="list-depth">
                    <li><a href="javascript:void(0)" onclick="NetfunnelChk.aTag('EVENT_LIST','<%=path %>/event');return false;" title="진행중 이벤트">진행중 이벤트</a></li>
                    <li><a href="javascript:void(0)" onclick="NetfunnelChk.aTag('EVENT_LIST','<%=path %>/event/end');return false;" title="지난 이벤트">지난 이벤트</a></li>
                    <li><a href="javascript:void(0)" onclick="NetfunnelChk.aTag('EVENT_LIST','<%=path %>/event/winner/list');return false;" title="당첨자발표">당첨자발표</a></li>
                </ul>
            </div>
            ...
            <div class="list position-5">
                ...
                <ul class="list-depth">
                    <li><a href="javascript:void(0)" onclick="NetfunnelChk.aTag('STORE_LIST','<%=path %>/store');return false;" title="새로운 상품">새로운 상품</a></li>
                    <li><a href="javascript:void(0)" onclick="NetfunnelChk.aTag('STORE_LIST','<%=path %>/store/megaticket');return false;" title="메가티켓">메가티켓</a></li>
                    <li><a href="javascript:void(0)" onclick="NetfunnelChk.aTag('STORE_LIST','<%=path %>/store/megachance');return false;" title="메가찬스">메가찬스</a></li>
                    <li><a href="javascript:void(0)" onclick="NetfunnelChk.aTag('STORE_LIST','<%=path %>/store/popcorn');return false;" title="팝콘/음료/굿즈">팝콘/음료/굿즈</a></li>
            ...
            <div class="list position-6">
                ...
                <ul class="list-depth mymage">
		                    ...
		                    <li><a href="javascript:movePage('<%=path %>/mypage/point-list',			'로그인이 필요한 서비스 입니다. \n로그인하시겠습니까?');" title="멤버십포인트">멤버십포인트</a></li>
		                    <li><a href="javascript:movePage('<%=path %>/mypage/moviestory',			'로그인이 필요한 서비스 입니다. \n로그인하시겠습니까?');" title="나의 무비스토리">나의 무비스토리</a></li>
		                    <li><a href="javascript:movePage('<%=path %>/mypage/myevent',				'로그인이 필요한 서비스 입니다. \n로그인하시겠습니까?');" title="나의 이벤트 응모내역">나의 이벤트 응모내역</a></li>
		                    <li><a href="javascript:movePage('<%=path %>/mypage/myinquiry',			'로그인이 필요한 서비스 입니다. \n로그인하시겠습니까?');" title="나의 문의내역">나의 문의내역</a></li>
		                    <li><a href="#" title="자주쓰는 할인 카드">자주쓰는 할인 카드</a></li>
		                    <li><a href="javascript:movePage('<%=path %>/on/oh/ohh/Mypage/mainPage.do?returnURL=info','로그인이 필요한 서비스 입니다.');" title="회원정보">회원정보</a></li>
            ...
            <div class="list position-7">
                ...
                <ul class="list-depth">
                    <li><a href="<%=path %>/benefit/membership.html" title="멤버십 안내">멤버십 안내</a></li>
                    <li><a href="<%=path %>/benefit/viplounge.html" title="VIP LOUNGE">VIP LOUNGE</a></li>
                    <li><a href="<%=path %>/benefit/discount/guide.html" title="제휴/할인">제휴/할인</a></li>
                </ul>
            </div>
            ...
            <div class="list position-8">
                ...
                <ul class="list-depth">
                    <li><a href="<%=path %>/support.html" 			title="고객센터 홈">고객센터 홈</a></li>
                    <li><a href="<%=path %>/support/faq.html"		title="자주묻는질문">자주묻는질문</a></li>
                    <li><a href="<%=path %>/support/notice.html"	title="공지사항">공지사항</a></li>
                    <li><a href="<%=path %>/support/inquiry.html"	title="1:1문의">1:1문의</a></li>
                    <li><a href="<%=path %>/support/rent.html"		title="단체/대관문의">단체/대관문의</a></li>
                    <li><a href="<%=path %>/support/lost.html"		title="분실물문의">분실물문의</a></li>
                </ul>
            </div>
            ...
            <div class="list position-9">
                ...
                <ul class="list-depth">
                    <li><a href="<%=path %>/megaboxinfo.html" 			target="_blank" title="메가박스소개">메가박스소개</a></li>
                    <li><a href="<%=path %>/socialcontribution.html" 	target="_blank" title="사회공헌">사회공헌</a></li>
                    <li><a href="<%=path %>/advertize.html" 			target="_blank" title="홍보자료">홍보자료</a></li>
                    <li><a href="<%=path %>/partner.html" 				target="_blank" title="제휴/부대사업문의">제휴/부대사업문의</a></li>
                    <li><a href="<%=path %>/onlinereport.html" 		target="_blank" title="온라인제보센터">온라인제보센터</a></li>
                    <li><a href="<%=path %>/ir.html" 					target="_blank" title="자료">IR자료</a></li>
                    <li><a href="<%=path %>/recruit.html" 				target="_blank" title="인재채용림">인재채용</a></li>
            ...
            <div class="list position-10">
                ...
                <ul class="list-depth">
                    <li><a href="<%=path %>/support/terms.html"		title="이용약관">이용약관</a></li>
                    <li><a href="<%=path %>/support/privacy.html"		title="개인정보처리방침">개인정보처리방침</a></li>
                    <li><a href="<%=path %>/support/screenrule.html"	title="스크린수배정에관한기준">스크린수배정에관한기준</a></li>
                </ul>
            </div>
...
<input type="hidden" id="playDe" name="playDe" value=""/>
    ...
    <div id="bokdMSeat" style="overflow:hidden; display:none; height:736px;">
        <iframe id="frameBokdMSeat" src="<%=path %>/on/oh/ohz/PcntSeatChoi/selectPcntSeatChoi4b68.html?megaboxLanguage=kr" title="관람인원선택 프레임" scrolling="no" frameborder="0" class="reserve-iframe" style="width:100%; height:736px;"></iframe>
	</div>

    <div id="bokdMPayBooking" style="overflow:hidden; display:none; height:736px;">
       <iframe id="framePayBooking" src="<%=path %>/on/oh/ohz/PayBooking/completeSeat4b68.html?megaboxLanguage=kr" title="예매 결제" scrolling="no" frameborder="0" class="reserve-iframe" style="width:100%; height:736px;"></iframe>
	</div>
...
<div id="schdlContainer" class="container">
	<div class="page-util">
		<div class="inner-wrap">
			<div class="location">
				<span>Home</span>
				<a href="<%=path %>/theater/list.do" title="극장 페이지로 이동">극장</a>
				<a href="<%=path %>/theater/list.do" title="전체극장 페이지로 이동">전체극장</a>
				<a href="<%=path %>/theaterInfo.do?seq_branch=${dto.seq_branch}" title="극장정보 페이지로 이동">극장정보</a>
			</div>
		</div>
	</div>
	...
	<div id="contents" class="no-padding">
		...
		<div class="theater-detail-page">
			...
			<div class="bg-img" style="background-image:url('<%=path %>/static/pc/images/theater/img-theater-detail.jpg');"></div>
...
<footer id="footer">
    ...
    <div class="footer-top">
        <div class="inner-wrap">
            <ul class="fnb">
                <li><a href="<%=path %>/megaboxinfo.html" title="회사소개 페이지로 이동">회사소개</a></li>
                <li><a href="<%=path %>/recruit.html" title="인재채용 페이지로 이동">인재채용</a></li>
                <li><a href="<%=path %>/socialcontribution.html" title="사회공헌 페이지로 이동">사회공헌</a></li>
                <li><a href="<%=path %>/partner.html" title="제휴/광고/부대사업문의 페이지로 이동">제휴/광고/부대사업문의</a></li>
                <li><a href="<%=path %>/support/terms.html" title="이용약관 페이지로 이동">이용약관</a></li>
                <li class="privacy"><a href="<%=path %>/support/privacy.html" title="개인정보처리방침 페이지로 이동">개인정보처리방침</a></li>
...
<!-- Mirrored from www.megabox.co.kr/theater?brchNo=1372 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jul 2020 06:35:52 GMT -->
</html>