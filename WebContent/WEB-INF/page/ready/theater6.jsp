...
<!-- Mirrored from www.megabox.co.kr/theater?brchNo=1359 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jul 2020 06:35:52 GMT -->
...
<head>
	...
	<link rel="shortcut icon" href="static/pc/images/favicon.ico" />
		...
		<title>(강남대로(씨티))극장정보 | 라이프씨어터, 메가박스</title>
		<meta property="name"			id="metaTagTitle"	content="극장정보 &lt; 극장"/>
		<meta property="description"	id="metaTagDtls"	content="반갑습니다. 메가박스 (강남대로(씨티))점 입니다."/>
		...
		<meta property="og:url" 		id="fbUrl"		content="theater2384.html?brchNo=1359" />
		<meta property="og:title" 		id="fbTitle"	content="극장정보 &lt; 극장" />
		<meta property="og:description"	id="fbDtls"		content="반갑습니다. 메가박스 (강남대로(씨티))점 입니다."/>
...
<script type="text/javascript">
	...
	function fn_chgFavor(deleteYn) {
		...
		var paramData = {'brchNo' : '1359', 'deleteYn' : deleteYn};
	...
	function fn_brchInfo() {
		...
		var paramData = {'areaCd' : '10', 'brchNo' : '1359'};
	...
	function setMetaTagNNavi(index) {
		...
		switch (index) {
		case 0 :
			paramData.metaTagUrl    = location.protocol + '//' + document.domain + '/theater?brchNo=1359';
			paramData.metaTagMenuId = 'ON00000038';
			paramData.metaTagDtls   = '반갑습니다. 메가박스 강남대로&#40;씨티&#41;점 입니다.';
			break;
		case 1 :
			paramData.metaTagUrl    = location.protocol + '//' + document.domain + '/theater/time?brchNo=1359';
			paramData.metaTagMenuId = 'ON00000037';
			paramData.metaTagDtls   = '반갑습니다. 메가박스 강남대로&#40;씨티&#41;점 입니다.';
			break;
		case 2 :
			paramData.metaTagUrl    = location.protocol + '//' + document.domain + '/theater/price?brchNo=1359';
...
<!-- Mirrored from www.megabox.co.kr/theater?brchNo=1359 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jul 2020 06:35:54 GMT -->
</html>