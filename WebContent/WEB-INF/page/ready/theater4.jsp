...
<!-- Mirrored from www.megabox.co.kr/theater?brchNo=1202 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jul 2020 06:36:06 GMT -->
...
<head>
	...
	<link rel="shortcut icon" href="static/pc/images/favicon.ico" />
		...
		<title>(신촌)극장정보 | 라이프씨어터, 메가박스</title>
		<meta property="name"			id="metaTagTitle"	content="극장정보 &lt; 극장"/>
		<meta property="description"	id="metaTagDtls"	content="반갑습니다. 메가박스 (신촌)점 입니다."/>
		...
		<meta property="og:url" 		id="fbUrl"		content="theater6f66.html?brchNo=1202" />
		<meta property="og:title" 		id="fbTitle"	content="극장정보 &lt; 극장" />
		<meta property="og:description"	id="fbDtls"		content="반갑습니다. 메가박스 (신촌)점 입니다."/>
...
<script type="text/javascript">
	...
	function fn_chgFavor(deleteYn) {
		...
		var paramData = {'brchNo' : '1202', 'deleteYn' : deleteYn};
	...
	function fn_brchInfo() {
		...
		var paramData = {'areaCd' : '10', 'brchNo' : '1202'};
	...
	function setMetaTagNNavi(index) {
		...
		var paramData = { 'scnTitle'     : '(신촌)' + tabNm + ' > 전체극장 , 메가박스'
						, 'metaTagTitle' : '(신촌)' + tabNm + ' > 전체극장 , 메가박스'
						, 'metaTagImg'   : 'http://image2.megabox.co.kr/mop/event.html/2018/6F/03D492-6FD4-485F-AE3F-2D3E2A41046F.jpg'};

		switch (index) {
		case 0 :
			paramData.metaTagUrl    = location.protocol + '//' + document.domain + '/theater?brchNo=1202';
			paramData.metaTagMenuId = 'ON00000038';
			paramData.metaTagDtls   = '반갑습니다. 메가박스 신촌점 입니다.';
			break;
		case 1 :
			paramData.metaTagUrl    = location.protocol + '//' + document.domain + '/theater/time?brchNo=1202';
			paramData.metaTagMenuId = 'ON00000037';
			paramData.metaTagDtls   = '반갑습니다. 메가박스 신촌점 입니다.';
			break;
		case 2 :
			paramData.metaTagUrl    = location.protocol + '//' + document.domain + '/theater/price?brchNo=1202';
			paramData.metaTagMenuId = 'ON00000039';
			paramData.metaTagDtls   = '메가박스 신촌점의 관람료를 확인하세요.';
			break;
		}
...
<!-- Mirrored from www.megabox.co.kr/theater?brchNo=1202 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jul 2020 06:36:07 GMT -->
</html>