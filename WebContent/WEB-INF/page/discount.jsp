...
<link rel="stylesheet" href="../../../css/megabox.min.css" media="all" />
	...
	<link rel="shortcut icon" href="/static/pc/images/favicon.ico" />
		...
		<meta property="name"			id="metaTagTitle"	content="할인안내 &lt; 혜택"/>
		...
		<meta property="og:url" 		id="fbUrl"		content="https://www.megabox.co.kr/benefit/discount/guide" />
		<meta property="og:title" 		id="fbTitle"	content="할인안내 &lt; 혜택" />
		...
		<div class="wrap" style="width: 850px; height: 556px; margin-left: -425px; margin-top: -278px;">
			...
			<div class="layer-con" style="height: 511px;">
				...
				<div class="tab-list tab-layer">
					<ul>
						<li class="on"><a href="#" title="회원 로그인 선택">회원 로그인<!--회원 로그인--></a></li>
...
<header id="header" >
		...
		<div class="wrap">
			...
			<div class="box">
				<div class="col">
					...
					<div class="link">
						<a href="#" title="chrome 다운로드" target="_blank">
    ...
    <div class="util-area">
        ...
        <div class="right-link">
            ...
            <div class="before" style="display:none">
                <a href="#'default','pc')" title="로그인">로그인</a>
    ...
    <nav id="gnb">
        <ul class="gnb-depth1">
            ...
            <li><a href="#" onclick="NetfunnelChk.aTag('EVENT_LIST','/event');return false;" class="gnb-txt-event" title="이벤트">이벤트</a>
                <div class="gnb-depth2">
                    <ul>
                        <li><a href="#" onclick="NetfunnelChk.aTag('EVENT_LIST','/event');return false;"		title="진행중 이벤트">진행중 이벤트</a></li>
                        <li><a href="#" onclick="NetfunnelChk.aTag('EVENT_LIST','/event/end');return false;"	title="지난 이벤트">지난 이벤트</a></li>
                        <li><a href="#" onclick="NetfunnelChk.aTag('EVENT_LIST','/event/winner/list');return false;"	title="당첨자발표">당첨자발표</a></li>
                    </ul>
                </div>
            </li>
            <li><a href="#" onclick="NetfunnelChk.aTag('STORE_LIST','/store');return false;" class="gnb-txt-store" title="스토어">스토어</a></li>
        ...
        <div class="wrap">
            ...
            <div class="list position-1">
                ...
                <ul class="list-depth">
                    <li><a href="#" title="전체영화">전체영화</a></li>
                    <li><a href="#" title="큐레이션">큐레이션</a></li>
                    <li><a href="#" onclick="javascript:MegaboxUtil.Common.moveMovieFilmCheck();" title="영화제">영화제</a></li>
                    <li><a href="#" title="무비포스트">무비포스트</a></li>
                </ul>
            </div>
            ...
            <div class="list position-5">
                ...
                <ul class="list-depth">
                    <li><a href="#" onclick="NetfunnelChk.aTag('STORE_LIST','/store');return false;" title="새로운 상품">새로운 상품</a></li>
                    <li><a href="#" onclick="NetfunnelChk.aTag('STORE_LIST','/store/megaticket');return false;" title="메가티켓">메가티켓</a></li>
                    <li><a href="#" onclick="NetfunnelChk.aTag('STORE_LIST','/store/megachance');return false;" title="메가찬스">메가찬스</a></li>
                    <li><a href="#" onclick="NetfunnelChk.aTag('STORE_LIST','/store/popcorn');return false;" title="팝콘/음료/굿즈">팝콘/음료/굿즈</a></li>
				...
				<div class="inner-wrap mt40">
					...
					<div class="tab-list fixed">
						<ul>
							...
							<li><a href="#" id="tab_credit"   title="신용카드 탭으로 이동">신용카드(160)</a></li>
							<li><a href="#" id="tab_telecom" title="통신사 탭으로 이동">통신사(6)</a></li>
							<li><a href="#" id="tab_point"     title="포인트 기타제휴 탭으로 이동">포인트/기타제휴(16)</a></li>
						...
						<div class="select-group">
							<div class="block col-3">
								<div class="col">
									...
									<div class="number" id="ckc01cnt">0</div>
								...
								<div class="col">
									<div class="tit-area">
										...
										<a href="#" title="신용카드 전체보기">전체보기 <i class="iconset ico-arr-right-gray-small"></i></a>
									</div>

									<div class="number" id="ckc02cnt">0</div>
								...
								<div class="col">
									<div class="tit-area">
										...
										<a href="#" title="포인트 기타제휴 전체보기">전체보기 <i class="iconset ico-arr-right-gray-small"></i></a>
									</div>

									<div class="number" id="ckc03cnt">0</div>
							...
							<div class="block mt25">
								<div class="col">
									<div class="tit-area">
										...
										<a href="#" title="상품권 관람권 전체보기">전체보기 <i class="iconset ico-arr-right-gray-small"></i></a>
									</div>
								</div>
							</div>
						</div>
