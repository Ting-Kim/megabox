...
<title>메가박스 < 이벤트 | 라이프씨어터, 메가박스</title>
<meta property="name" id="metaTagTitle" content="메가박스 &lt; 이벤트" />
...
<meta property="og:url" id="fbUrl"
	content="https://www.megabox.co.kr/event/megabox?currentPage=1&amp;recordCountPerPage=1000&amp;eventStatCd=ONG&amp;eventTitle=" />
<meta property="og:title" id="fbTitle" content="메가박스 &lt; 이벤트" />
										...
										<div class="login-input-area">
												...
												<div class="right">
													<div class="hp-ad">
														<a href="#" title="휴대폰 간편 로그인 선택" target="_blank"
															title="새창 열림"><span>휴대폰 간편로그인<!--휴대폰 간편로그인--></span>
															<em>광고<!--광고--></em></a>
													</div>
												</div>
											</div>
											...
											<div class="sns-login">
												<a href="#" lnkgTy="FACEBOOK" title="페이스북으로 로그인 선택"><img
													...
													alt="페이스북">
												<!--페이스북--> 페이스북으로 로그인<!--페이스북으로 로그인--></a> <a href="#"
													lnkgTy="NAVER" title="네이버로 로그인 선택"><img
			...
			<div class="util-area">
				...
				<div class="right-link">
					...
					<div class="before" style="display: none">
						<a href="#" title="로그인">로그인</a> <a href="#" title="회원가입">회원가입</a>
					</div>
    ...
    -->
			...
			<nav id="gnb">
				<ul class="gnb-depth1">
					...
					<li><a href="../theater/list.do" class="gnb-txt-theater"
						title="극장">극장</a>
						<div class="gnb-depth2">
							<ul>
						...
						<div class="gnb-depth2">
							<ul>
								<li><a href="<%=path %>/event.do" title="진행중 이벤트">진행중
										이벤트</a></li>
								<li><a href="<%=path%>/event/past.do?type=6" title="지난 이벤트">지난
										이벤트</a></li>
					...
					<li><a href="<%=path %>/benefit/membership.do"
						...
						<div class="gnb-depth2">
							<ul>
								<li><a href="../benefit/membership.do" title="메가박스 멤버십">메가박스
										멤버십</a></li>
			...
			<div id="layer_sitemap" class="header-layer layer-sitemap">
				<div class="wrap">
					...
					<div class="list position-7">
						...
						<ul class="list-depth">
							<li><a href="../benefit/membership.do" title="멤버십 안내">멤버십
									안내</a></li>
							<li><a href="../benefit/viplounge.do" title="VIP LOUNGE">VIP
									LOUNGE</a></li>
							<li><a href="../benefit/discount.do" title="제휴/할인">제휴/할인</a></li>
						</ul>
					</div>
		...
		<div class="container">
			...
			<div id="contents">
				...
				$(function(){
					...
					var num = url.substring(url.length-1, url.length);
					
					
					if (num!="?") {
						$('#eventTab_').removeClass();
					}
					
					switch (num) {
					case "?": 
						$('#eventTab_').addClass("on");						
						break;
					case "1": 
						$('#eventTab_CED03').addClass("on");
											
						break;
					case "2": 
						$('#eventTab_CED01').addClass("on");
											
						break;
					case "3": 
						$('#eventTab_CED02').addClass("on");
											
						break;
					case "4": 
						$('#eventTab_CED05').addClass("on");
											
						break;
					case "5": 
						$('#eventTab_CED04').addClass("on");
		 ...
		 $('#searchBtn').on('click', function() {
            ...
            window.location.href="<%=path%>/event/tab.do?type="+type+"&search="+search; 			
				...
				<div id="event-list-wrap">
					...
					<div class="inner-wrap">
						...
						<div class="event-list ">
							<input type="hidden" id="totCount" name="totCount" value="9">
							<ul>

								<c:forEach items="${ list}" var="dto">
									<li><a href="info.do?num=${dto.seq_event }"
										class="eventBtn" title="${dto.title }"> <!--<p class="img"><img src="../../../static/pc/images/event/@img-event-list-megabox.jpg" alt="" /></p>-->
											<p class="img">
