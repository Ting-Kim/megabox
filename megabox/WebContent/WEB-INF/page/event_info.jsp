...
<head>
	...
	<link rel="shortcut icon" href="https://www.megabox.co.kr/static/pc/images/favicon.ico" />
		...
		<title><반도> '부산행'의 생존자를 찾습니다! 전대미문의 포인트 이벤트 < 이벤트 | 라이프씨어터, 메가박스</title>
		...
		<div class="inner-wrap">
			<div class="location">
				<span>Home</span>
					...
					<a href="javascript:void(0)" onclick="NetfunnelChk.aTag('EVENT_LIST','/event');return false;" title="진행중 이벤트 페이지로 이동">이벤트</a>
	...
	<div id="contents">
		...
		<div class="event-detail">
			...
			<p class="event-detail-date">
				<span>기간</span>
				<em>${dto.start_date} ~ ${ dto.end_date}</em>
			</p>
			
		
			<c:if test="${dto.content1!=null &&dto.content2==null && dto.content3==null &&dto.content4==null}">
			<div class="event-html">
			<img alt="" src="<%=path %>${ dto.content1 }" style="width: 1100px; height: 4344;"><!-- 4344 -->
			</div>
			</c:if>
			
			
			<!-- /img/event/e_info/m01.jpg -->
			<c:if test="${dto.content1 != null && dto.content2 == null && dto.content3 != null && dto.content4 == null }">
			<div class="event-html">
			<img alt="" src="<%=path %>${dto.content1}" style="width: 1100px; height: 2172;"><!-- 4344 -->
			</div>
			<c:if test="${dto.video!=null}">
			<div class="event-html" id="player">
			 ${dto.video}
			</div>
			</c:if>
			<div class="event-html">
			<img alt="" src="<%=path %>${dto.content3}" style="width: 1100px; height: 2172px;"><!-- 4344 -->
			</div>
			</c:if>
			...
			<c:if test="${ dto.content1!=null &&dto.content2 !=null && dto.content3 !=null && dto.content4!=null}">
			<div class="event-html">
			<img alt="" src="<%=path %>${dto.content1}" style="width: 1100px; height: 1086px;"><!-- 4344 -->
			</div>
			<div class="event-html">
			<img alt="" src="<%=path %>${dto.content2}" style="width: 1100px; height: 1086px;"><!-- 4344 -->
			</div>
			<c:if test="${dto.video!=null }">
			<div class="event-html" id="player">
			<iframe ${dto.video }></iframe>
			</c:if>
			<div class="event-html">
			<img alt="" src="<%=path %>${dto.content3}" style="width: 1100px; height: 1086px;"><!-- 4344 -->
			</div>
			<div class="event-html">
			<img alt="" src="<%=path %>${dto.content4}" style="width: 1100px; height: 1086px;"><!-- 4344 -->
			</div>
			</c:if>
...
<div class="inner-wrap">
	...
	<c:if test="${dto.notice_date!=null&& dto.end_date <dto.sysdate}">
	<div class="event-button-type">			
							<button type="button" class="btn" id="btnInsertEvt_1_" data-no1=1 data-no2= >응모하기</button>
						
					
					<input type="hidden" name="eventCponOrd" value="1"/>
					<input type="hidden" name="eventBrchOrd" value=""/>
	</div>
	</c:if>
	</c:forEach>
	<!--// event-button-type -->
