	...
	<div class="page-util">
		<div class="inner-wrap">
			<div class="location">
				...
				<a href="/event/winner/list" title="당첨자발표 페이지로 이동">당첨자발표</a>
			</div>
		...
		<div class="inner-wrap">
			...
			<div class="table-wrap">
				...
				<div class="board-view">
					...
					<div class="info">
						<p>
							<span class="txt">${dto.start_date} ~ ${ dto.end_date}</span>
						</p>
					</div>
...
${fn:replace(dto.content ,cn,br)}



<br>
<br>
<%-- <c:forEach items="${dto.array}" var="arr">
${arr}<br>
</c:forEach --%>
...
감사합니다.
					...
					<div class="btn-group border pt40">
						<a href="<%=path %>/event/board.do" onclick="hisBack()" class="button large winnerlist" title="목록 페이지로 이동">목록</a>
					</div>
