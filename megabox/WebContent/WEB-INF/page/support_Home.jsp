		...
		<div class="inner-wrap">
			<div class="lnb-area">
				<nav id="lnb">
					...
					<ul>
						<li><li class="on"><a href="<%=path %>/support.do" title="고객센터 홈">고객센터 홈</a></li>
				...
				<div class="custo-main">
					<div class="main-block">
						<div class="block-content">
							<a href="<%=path %>/support/faq.do" title="자주 묻는 질문 페이지로 이동">
								<p>
						...
						<div class="block-content">
							<a href="<%=path %>/support/lost.do" title="분실물 문의 페이지로 이동">
								<p>
						...
						<div class="block-content">
							<a href="<%=path %>/support/inquiry.do" title="1:1 문의 페이지로 이동">
								<p>
						...
						<div class="block-content">
							<a href="<%=path %>/support/rent.do" title="단체관람 및 대관문의 페이지로 이동">
								<p>
						...
						<div class="block-content">
							<a href="<%=path %>/benefit/discount/guide.do" title="할인카드 안내 페이지로 이동">
								<p>
					...
					<div class="notice-wrap">
						<div class="block left">
							<div class="tit-area">
								...
								<a href="<%=path %>/support/faq.do" class="more" title="더보기">더보기 <i class="iconset ico-arr-right-gray ml07"></i></a>
							</div>
							<div class="">
								<ol class="decimal-list">
										...
										<li>
											<a href="#" class="faqBtn" data-idx="4" title="질문 상세보기">
												...
												<span class="font-gblue">[VIP]</span> VIP가 되면 어떤 혜택을 받을 수 있나요?
												<span class="date">2020.03.13</span>
											</a>
										</li>
										...
										<li>
											<a href="#" class="faqBtn" data-idx="5" title="질문 상세보기">
												...
												<span class="font-gblue">[홈페이지/모바일]</span> 자주쓰는 카드 등록은 어떻게 하나요?
												<span class="date">2020.03.13</span>
											</a>
										</li>
						...
						<div class="block right">
							<div class="tit-area">
								...
								<a href="<%=path %>/support/notice.do" class="more" title="더보기">더보기 <i class="iconset ico-arr-right-gray ml07"></i></a>
							</div>
							...
							<div class="decimal-list">
								<ol>
										...
										<li>
											<a href="<%=path %>/support/noticePage.do?seqNotice=16" class="moveBtn" data-no="10120" title="공지사항 상세보기">
												
													
														<span class="font-gblue"><i class="iconset ico-notice"></i> [목동]</span>
										...
										<li>
											<a href="<%=path %>/support/noticePage.do?seqNotice=18" class="moveBtn" data-no="10119" title="공지사항 상세보기">
												...
												[지점] 메가박스 목동지점 건물 외부 출입구 리모델링 공사 안내
												<span class="date">2020.07.10</span>
											</a>
										</li>
									
										<li>
											<a href="<%=path %>/support/noticePage.do?seqNotice=15" class="moveBtn" data-no="10118" title="공지사항 상세보기">
												...
												[지점] [목동] 건물 내 전기 작업 관련 안내
												<span class="date">2020.07.08</span>
											</a>
										</li>
									
										<li>
											<a href="<%=path %>/support/noticePage.do?seqNotice=10" class="moveBtn" data-no="10117" title="공지사항 상세보기">
												
													
													
														<span class="font-purple"><i class="iconset ico-marker"></i> [홍대]</span>
													
												
												[공지] <하이큐!! 땅 VS 하늘> 4주차 특전 지급 안내
												<span class="date">2020.07.06</span>
											</a>
										</li>
									
										<li>
											<a href="<%=path%>/support/noticePage.do?seqNotice=12" class="moveBtn" data-no="10116" title="공지사항 상세보기">
												
													
													
														<span class="font-purple"><i class="iconset ico-marker"></i> [메가박스]</span>
													
												
											앙상블 스타즈 Night of Blossoming Star 진행안내
												<span class="date">2020.07.06</span>
											</a>
										</li>
					...
					<div class="event">
							...
							<div class="left-banner">
								<a href="#" class="eventBtn" data-no="8535" data-netfunnel="N" title="이벤트 상세보기"><img src="https://img.megabox.co.kr/SharedImg/event/2020/07/10/Tlxz4ZhL9UoG3a2fQfdxZt1Ln9dWvlyO.jpg" alt="&lt;반도&gt; &#39;부산행&#39;의 생존자를 찾습니다! 전대미문의 포인트 이벤트"></a>
							</div>
	
							<div class="right-banner">
								<a href="#" class="eventBtn" data-no="8529" data-netfunnel="N" title="이벤트 상세보기"><img src="https://img.megabox.co.kr/SharedImg/event/2020/07/13/3rdDjxOaE5fGdKugWhCjeAHPC4fFN40w.jpg" alt="[돌비 시네마] VIP 사전 무료 시사회"></a>
							</div>
