...
<script src="/static/pc/js/ui.common.js?v=1594619059364"></script>
<script src="//cast.imp.joins.com/head/jJw0dsD1tmyP4K69GjsS1ul36iDmHFN28dfabqsdCuSEAM4qWzAZAbZNQkt6b0k4ZVJLYVlQNnBhSV85VVpnAstB17se20EZlgPLQde7HttBGZY.js?url=https%3A%2F%2Fwww.megabox.co.kr%2Fon%2Foh%2Fohg%2FMbLogin%2FviewNonMbLogin.rest&amp;ref=https%3A%2F%2Fwww.megabox.co.kr%2Fmovie%2Fclassic"></script>
<script src="/static/pc/js/front.js?v=1594619059364"></script>
<script src="//rum.beusable.net/script/b200617e104748u388/bc4af2fa1e" async="" type="text/javascript"></script>
<script src="//rum.beusable.net/script/checker/b200617e104748u388/bc4af2fa1e?url=https%3A%2F%2Fwww.megabox.co.kr%2Fon%2Foh%2Fohg%2FMbLogin%2FviewNonMbLogin.rest" async="" type="text/javascript"></script>
</head>
<body class="bg-member">
    <div class="body-wrap">

<form id="nonMbBokdCnfmForm">
	<input type="hidden" name="nonMbNm" value="">
	<input type="hidden" name="nonMbTelno" value="">
	<input type="hidden" name="nonMbPwd" value="">
	<input type="hidden" name="nonMbByymmdd" value="">
</form>
<div class="member-wrap">
	<h1 class="ci"><a href="/main" title="MEGABOX : Life Theater">MEGABOX : Life Theater</a></h1>
	<div class="col-wrap">
		<div class="col">
			<p class="tit-member">비회원 예매 확인</p>
			<div class="table-wrap">
				<table class="board-form">
					<caption>이름, 생년월일, 휴대폰 번호, 비밀번호 항목을 가진 비회원 예매 확인 등록 표</caption>
					<colgroup>
					...
					<tbody>
						<tr>
							...
							<td>
								<input maxlength="20" id="ibxNonMbNm" type="text" placeholder="이름" class="input-text w300px">
							</td>
						</tr>
						<tr>
							<th scope="row"><label for="ibxNonMbByymmdd">생년월일</label></th>
							<td>
								<input maxlength="6" id="ibxNonMbByymmdd" placeholder="생년월일 앞 6자리" class="input-text w300px">
								<div id="ErrTextNonMbByymmdd" class="alert"></div>
							</td>
						</tr>
						<tr>
							<th scope="row"><label for="ibxNonMbTelno">휴대폰 번호</label></th>
							<td>
								<input maxlength="11" id="ibxNonMbTelno" placeholder="'-' 없이 입력" class="input-text w300px">
						...
						<tr>
							...
							<td>
								<input maxlength="4" id="ibxNonMbPwd" type="password" placeholder="숫자 4자리" class="input-text w300px">
								<div class="alert"></div>
							</td>
						</tr>
					</tbody>
			...
			<div class="btn-member-bottom">
				<button id="btnNonMbLogin" type="button" class="button purple large" disabled="disabled">비회원 예매확인</button>
			</div>
		</div>
	</div>
</div>
