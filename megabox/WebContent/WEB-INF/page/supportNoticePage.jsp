				...
				<div class="table-wrap">
					<div class="board-view">
						...
						<div class="info">
									...
									<p>
										...
										<span class="txt">${list.branch}</span>
									</p>
									<p>
										<span class="tit">구분</span>
										<span class="txt">${list.npart}</span>
									</p>
							...
							<p>
								...
								<span class="txt">${list.regidate}</span>
							</p>
						</div>
					...
					<div class="line prev">
						...
						<script>
								...
								<a href="<%=path%>/support/noticePage.do?seqNotice=${list.seq_notice-1}" class="link moveBtn" data-no="10101" title="메가박스 개인정보 처리방침 변경 안내">${list2.title}</a>
						
					</div>

					<div class="line next">
						<p class="tit">다음</p>
							<a href="<%=path%>/support/noticePage.do?seqNotice=${list.seq_notice+1}" class="link moveBtn" data-no="10099" title="[코엑스] 스타필드 코엑스몰 행사 진행에 따른 주차 안내 (6/25~28)">${list3.title}</a>
